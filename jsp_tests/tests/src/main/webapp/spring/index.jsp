<%@ page language="java" pageEncoding="UTF-8" import="java.util.*,cn.ptp.hibernate.message.*,cn.ptp.spring.*,ison.lib.*,org.springframework.context.support.ClassPathXmlApplicationContext,org.springframework.beans.factory.BeanFactory"%>
...
MessageDo mjDao = factory.getBean("messagedo", MessageDo.class);
List<cn.ptp.hibernate.message.Message> list = mjDao.msgList();
int k=1;
